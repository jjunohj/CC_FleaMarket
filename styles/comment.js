...
export function BoardNewCommentContainer({ children }) {
  return (
    <div
      css={{
        width: calcRem(1200),
...
export function BoardNewCommentContentsInput({}) {
  return (
    <input
      css={{
...
export function BoardNewCommentContentsContainer({ children }) {
  return (
    <div
      css={{
        boxSizing: "border-box",
...
export function BoardNewCommentInput({}) {
  return (
    <input
      css={{
        boxSizing: "border-box",
